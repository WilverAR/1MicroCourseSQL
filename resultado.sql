...
8. Does posing more reviews correlate with more fans? 
		...
		Sí, pero también es importante el tiempo que llevan utilizando Yelp. 
        Cuanto más tiempo llevan usando Yelp y cuantas más reseñas dan, mayor será su número de seguidores.
...
1. 	Pick one city and category of your choice and group the businesses in that city
	...
	i.	Do the two groups you chose to analyze have a different distribution of hours?
		El grupo de negocios con calificaciones de 4 a 5 estrellas parece tener horarios más cortos que el grupo de 2 a 3 estrellas.
        Tenga en cuenta que la consulta solo devolvió tres negocios, por lo que no es una muestra muy grande.
	
	ii.	Do the two groups you chose to analyze have a different number of reviews?	
		Sí y no, uno de los negocios del grupo de 4 a 5 estrellas tiene muchas más reseñas, pero el otro grupo de 4 a 5 estrellas tiene
        casi el mismo número de reseñas que el grupo de 2 a 3 estrellas.
	
	iii. Are you able to infer anything from the location data provided between these two
		groups? Explain.
		No, cada negocio se encuentra en un código postal diferente.
...
3. 	For this last part of your analysis, you are going to choose the type of analysis you
	...
	i. 	Indicate the type of analysis you chose to do:
		Nuestro objetivo es predecir si un negocio permanecerá abierto o cerrará, sin necesidad de analizar 
        explícitamente el contenido de las reseñas. Aunque cabe destacar que también sería interesante realizar un análisis de texto de las mismas.
	
	ii.	Write 1-2 brief paragraphs on the type of data you will need for your analysis
		and why you chose that data:		
		Se recopilarán datos sobre los negocios, como la calificación, la ubicación y la información de contacto, 
        y se utilizarán categorías y atributos para distinguir entre diferentes tipos de negocios. 
        También se registrará si el negocio está abierto o cerrado permanentemente.
	...
	iv. 	Provide the SQL code you used to create your final dataset:
		...
		SELECT B.id, B.name, B.address, B.city, B.state, B.postal_code, B.latitude, B.longitude, B.review_count, B.stars,
